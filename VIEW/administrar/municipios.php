...
require_once("../../CONTROLLERS/administrar/municipios.php");
...
<div id="page-content-wrapper">
  ...
  <div class="container-fluid" id="result">
    ...
    <div class="modal-content position-absolute">
      ...
      <div class="modal-con">
       <form  id="form-agg" action="../../CONTROLLERS/administrar/municipios.php" method="post" accept-charset="utf-8">
...
<span>Estado</span> <br>
    ...
    <input type="text" required="" name="municipio" value=""  class="agregar_data val" placeholder="Municipio">
...
<form id="formulario" method="post" action=""> 
 ...
 <tbody>
   <?php while ($municipios = $mun->fetch()): 

    if ($municipios['status']==TRUE): 
     $status='Activo';
  ...
  <tr>
   ...
   <td><?php echo $municipios['codmun'] ?></td>
   <td><?php echo $municipios['despai'] ?></td>
   <td><?php echo $municipios['desest'] ?></td>
   <td><?php echo $municipios['desmun'] ?></td>
   ...
   <td><input style="width: 100%;" name="eliminar" type="button" class="btn btn-danger btns eliminar" id="eliminar" onclick="Eliminar('../../CONTROLLERS/administrar/municipios.php','<?php echo $municipios['codmun'] ?>','municipios.php')"  value="Eliminar">

    <a href="../../VIEW/modificar/municipios.php?id=<?php echo $municipios['codmun']?>&&modificar=modificar" title=""><input style="width: 100%;"  class="btn btn-warning   btns modificar"  id="modificar" type="button" name="modificar" value="Modificar"></a> 
  </td>
