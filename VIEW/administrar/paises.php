...
require_once("../../CONTROLLERS/administrar/pais.php");
?>
...
<div id="page-content-wrapper">
  ...
  <form id="formulario" method="post" action=""> 
   ...
   <tbody>
     <?php while ($pais = $paises->fetch()): 


       ?>
       <tr>
         <td><?php echo $pais['codpai'] ?></td>
         <td><?php echo $pais['despai'] ?></td>
         <td><?php echo $pais['poblacion'] ?></td>
         <td><?php echo $pais['continente'] ?></td>
         <td><?php echo $pais['cont'] ?></td>
         <td><?php echo  $pais['seleccionado'] ?></td>
         <td><?php echo $pais['status']    ?></td>


         <td>

          <!-- <a href="../../CONTROLLERS/administrar/pais.php?id=<?= $pais['codpai']?>&&eliminar=eliminar"> --><input style="width: 100%;" name="eliminar" type="button" class="btn btn-danger btns eliminar" onclick="Eliminar('../../CONTROLLERS/administrar/pais.php','<?php echo $pais['codpai'] ?>','paises.php')" id="eliminar" value="Eliminar"><!-- </a> -->



          <a href="../../VIEW/modificar/pais.php?id=<?php echo $pais['codpai']?>&&modificar=modificar" title=""><input style="width: 100%;"  class="btn btn-warning   btns modificar"  id="modificar" type="button" name="modificar" value="Modificar"></a>
        </td>
