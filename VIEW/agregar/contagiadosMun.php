...
<div id="page-content-wrapper">
 ...
 <div class="container-fluid" >
  ...
  <form id="formulario" method="post" action="../../CONTROLLERS/agregar/contagiadosMun.php" name="formulario">
   <table border="0" style="top: 50px;width: 100%;left: 0;text-align: center;">
    ...
    <td class="borderTable" id="resultMun" style="width: 10%;text-align-last: center;font-weight: bold" ></td>   
    <td class="borderTable" id="inputR"style="width: 20%" ></td>
    <td class="borderTable" id="inputC"style="width: 20%" ></td>
    <td class="borderTable" id="inputF"style="width: 20%" ></td>

  </tr>
  <tr class="borderTable">
    <td colspan="5" rowspan="" class="borderTable" headers="" ><input type="text" id="fecha" required="" name="fecha" value="" placeholder="dd/mm/yyy" style="width: 100%;text-align: center;"></td>
  </tr>
...
<script>
  menu();
  var url='SIE/VIEW/agregar/contagiadosMun.php';
  link ='../../CONTROLLERS/agregar/select_mun.php';

 selectMun(url,link);

enviar('../../CONTROLLERS/agregar/contagiadosMun.php','contagiadosMun.php')
