    ...
    <?php while ($c = $centros->fetch()) {
      ?>
         <tr class="borderTable">
           <td class="borderTable"><?php echo $c['descentro'] ?><input type="hidden" name="id[]" value="<?php echo $c['codcentro'] ?>" placeholder=""></td><td class="borderTable"><input type="number" class="input val"  placeholder="Campo numérico" name="personas[]" value="" ></td>
         </tr>
      <?php  
    } ?>
    <tr class="borderTable">
...
BtnAgregar()
enviar(url,'personas-contagiadas.php')
