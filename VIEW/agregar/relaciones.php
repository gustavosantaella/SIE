...
<div id="page-content-wrapper">
  ...
  <div class="container-fluid" >
    ...
    <form id="formulario" method="post" action="../../CONTROLLERS/agregar/relaciones.php" name="formulario">
     <table border="1"style='left: 0;width: 100%;'>
      
      <tr>
        <th colspan="5" align="center" style="text-align: center">RELACIONES ENTRÉ PAÍSES SELECCIONADOS</th>
      </tr>
...
while($d = $data->fetch()):?>
 ...
 <tr>
   ...
   <td><input  class="input val" type="number" name="recuperados[]" value="" placeholder="Valor numérico"></td>
   <td><input  class="input val" type="number" name="contagiados[]" value="" placeholder="Valor numérico"></td>
