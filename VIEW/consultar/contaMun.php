...
include_once("../../CONTROLLERS/agregar/contagiadosMun.php");
...
<div id="page-content-wrapper">
 ...
 <div class="container-fluid" >
  ...
  <form id="formulario" method="post" action="../../CONTROLLERS/EXCEL_one/contaMun.php" name="formulario">
   ...
   <table border="0" style="top: 50px;width: 100%;left: 0;text-align: center;">
    ...
    <tr class="borderTable">
     <td class="borderTable" style="width: 25%;text-align: center" ><input type="text" name="estado" value="<?php echo $estado; ?>"class="input" readonly style="border:1px solid rgba(100,100,100,.3);font-weight: bold;">
      <input type="hidden"readonly name="codest" value="<?php echo $codest ?>" placeholder=""></td>


     <td class="borderTable" id="resultMun" style="width: 10%;text-align-last: center;font-weight:bold" ><?php

     for($i=0;$i<count($codmun);$i++){
       ?>
       <input type="text" name="municipio[]" readonly="false" class="input val" style="border:1px solid rgba(100,100,100,.3);font-weight: bold;"value="<?php echo $mun[$i] ?>" placeholder="">
       <input type="hidden"readonly name="codmun[]" value="<?php echo $codmun[$i] ?>" placeholder="">
       <?php 
     }
     ?>
   </td>   
   ...
   <tr>
     <td class="borderTable">Total general de casos</td><td  colspan="5" class="borderTable"><?php echo $cc; ?></td>

   </tr>
   <tr>
     <td class="borderTable">Total de casos comunitarios</td><td  colspan="5" class="borderTable"><?php echo $total; ?></td>
   </tr>

 </tr>
 <tr class="borderTable">
  <td colspan="5" rowspan=""  class="borderTable" headers="" align="left" ><input type="text" class="input " readonly="" style="border:1px solid rgba(100,100,100,.3);text-align:center!important;"id="fecha" required="" name="fecha" value="<?php echo $fecha ?>" placeholder="dd/mm/yyy" ></td>
</tr> 

<tr>
 <a href="../../CONTROLLERS/EXCEL_one/contaMun.php" title=""><td colspan="2"> <input class=" btn btn-success btn-op excel" accept="../../CONTROLLERS/EXCEL_one/contaMun.php?"  style="left:54.5%;transform: scale(1.0);" type="button" id="btn-enviar" value="EXCEL"></input></a>

  &nbsp;&nbsp;&nbsp;&nbsp;


  <input class=" btn btn-danger btn-op pdf"  accept="../../CONTROLLERS/PDF_one/comportamientoVE/contaMun.php?" style="left:50%;transform: scale(1.0);" type="button" id="btn-enviar" value="PDF"></input>

  <input class=" btn btn-primary btn-op pdf" accept="../graficas/contaMun.php?" style="left:50%;transform: scale(1.0);" type="button" id="btn-enviar" value="GRÁFICA"></input></td>
</tr>
