...
require_once("../../CONTROLLERS/agregar/encuestaPatria.php");
...
<tr class="borderTable">
       <td  style="width: auto;" class="borderTable"><input type="text" name="encuesta[]" readonly="" style="font-weight: bold;" class="input" value="<?php echo $data['desencuesta'] ?>" placeholder=""></td>
...
endwhile;
 ...
 <tr class="borderTable">
      ...
      <tr >
        <td  style="position:relative;left: 10%;"colspan="2"><input class=" btn btn-success btn-op" type="button" id="btn-enviar" accept="../../CONTROLLERS\EXCEL_one\encuesta.php?" value="EXCEL">
          
          <input class=" btn btn-danger btn-op" type="button" id="btn-enviar" value="PDF" accept="../../CONTROLLERS/PDF_one/comportamientoVE/encuestaPatria.php?">

          <input class=" btn btn-primary btn-op" accept="../../VIEW/graficas/encuesta.php?" type="button" id="btn-enviar" value="GRÁFICA">
        </input></td>
      </tr>
