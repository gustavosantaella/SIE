<?php require_once("../../CONTROLLERS/agregar/contagiadosMun.php"); ?>
<!DOCTYPE html>
<html lang="en">
 ...
 <a name="contenidosas" id="contenidosas" title=""><div class="confirm"></a>
  ...
  <div class="container-fluid">
    <div class="buscar" style="position: relative;top: 10px;left: 65%">
     <!--  <form id="formulario" method="post" action="../../VIEW/buscar/contaMun.php">
     ...
     <tbody>
       ...
       <td><?php echo $datos['desest'] ?></td>
        ...
        <a href="#contenidosas" title="">
          <td><a href="../../CONTROLLERS/agregar/contagiadosMun.php?eliminar=eliminar&&fecha=<?= $datos['fecha']?>&codest=<?php echo $datos['codest'] ?>"><input style="width: 50%;" type="button" class="btn btn-danger btns eliminar" id="eliminar" value="Eliminar"></a>



            <a href="../../VIEW/consultar/contaMun.php?fecha=<?php echo $datos['fecha'] ?>&&codest=<?php echo $datos['codest'] ?>" title=""><input style="width: 50%;" class="btn btn-primary btns consultar" id="consultar" type="button" name="" value="Consultar"></a> 

            <a href="../modificar/contaMun.php?fecha=<?php echo $datos['fecha'] ?>&codest=<?php echo $datos['codest'] ?>" title=""><input style="width: 50%;" class="btn btn-warning  btns modificar" id="modificar" type="button" name="" value="Modificar"></a> 
          </td>
        </tr>
      </tbody>
