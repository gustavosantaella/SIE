<?php require_once("../../CONTROLLERS/agregar/covidPar.php"); ?>
<!DOCTYPE html>
<html lang="en">
...
<a name="contenidosas" id="contenidosas" title=""><div class="confirm"></a>
  ...
  <div class="container-fluid">
    <div class="buscar" style="position: relative;top: 10px;left: 65%">
     <!--  <form id="formulario" method="post" action="../../VIEW/buscar/covidPar.php">
...
<td>MUNICIPIO</td>
   ...
   while ($datos = $listar->fetch()) { 
     ...
     <tbody>
       ...
       <td><?php echo $datos['desest'] ?></td>
       <td><?php echo $datos['desmun'] ?></td>
        ...
        <a href="#contenidosas" title="">
          <td><a href="../../CONTROLLERS/agregar/covidPar.php?fecha=<?= $datos['fecha']?>&codest=<?php echo $datos['codest'] ?>&codmun=<?php echo $datos['codmun'] ?>&&eliminar=eliminar"><input style="width: 50%;" type="button" class="btn btn-danger btns eliminar" id="eliminar" value="Eliminar"></a>



            <a href="../../VIEW/Consultar/covidPar.php?fecha=<?php echo $datos['fecha'] ?>&codest=<?php echo $datos['codest'] ?>&codmun=<?php echo $datos['codmun'] ?>" title=""><input style="width: 50%;" class="btn btn-primary btns consultar" id="consultar" type="button" name="" value="Consultar"></a> 

            <a href="../modificar/covidPar.php?fecha=<?php echo $datos['fecha'] ?>&codest=<?php echo $datos['codest'] ?>&codmun=<?php echo $datos['codmun'] ?>" title=""><input style="width: 50%;" class="btn btn-warning  btns modificar" id="modificar" type="button" name="" value="Modificar"></a> 
          </td>
        </tr>
      </tbody>
