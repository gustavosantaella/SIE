<?php require_once("../../CONTROLLERS/agregar/encuestaPatria.php"); ?>
<!DOCTYPE html>
<html lang="en">
     ...
     <tbody>
       ...
       <td><?php echo $datos['id'] ?></td>
        ...
        <a href="#contenidosas" title="">
          <td><a href="../../CONTROLLERS/agregar/encuestaPatria.php?eliminar=eliminar&&fecha=<?= $datos['fecha']?>"><input style="width: 50%;" type="button" class="btn btn-danger btns eliminar" id="eliminar" value="Eliminar"></a>



            <a href="../../VIEW/consultar/encuestaPatria.php?fecha=<?php echo $datos['fecha'] ?>" title=""><input style="width: 50%;" class="btn btn-primary btns consultar" id="consultar" type="button" name="" value="Consultar"></a> 

            <a href="../modificar/encuestaPatria.php?fecha=<?php echo $datos['fecha'] ?>" title=""><input style="width: 50%;" class="btn btn-warning  btns modificar" id="modificar" type="button" name="" value="Modificar"></a> 
          </td>
        </tr>
      </tbody>
...
<script>menu();
/*var url='../../CONTROLLERS/listar/encuestaPatria.php';
listar(url)*///buscar();</script>
