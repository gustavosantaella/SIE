<?php require_once("../../CONTROLLERS/agregar/personas-contagiadas.php"); ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
 ...
 <a name="contenidosas" id="contenidosas" title=""><div class="confirm"></a>
  ...
  <!--   <div class="buscar" style="position: relative;top: 10px;left: 65%">
      <form id="formulario" method="post" action="../../VIEW/buscar/personasContagiadasBuscar.php">
     ...
     <tbody>
       ...
       <td><?php echo $datos['id'] ?></td>
        ...
        <a href="#contenidosas" title="">
          <td><a href="../../CONTROLLERS/agregar/personas-contagiadas.php?eliminar=eliminar&&fecha=<?= $datos['fecha']?>"><input style="width: 50%;" type="button" class="btn btn-danger btns eliminar" id="eliminar" value="Eliminar"></a>



            <a href="../../VIEW/consultar/personasContagiadas.php?fecha=<?php echo $datos['fecha'] ?>" title=""><input style="width: 50%;" class="btn btn-primary btns consultar" id="consultar" type="button" name="" value="Consultar"></a> 

            <a href="../modificar/personasContagiadas.php?fecha=<?php echo $datos['fecha'] ?>" title=""><input style="width: 50%;" class="btn btn-warning  btns modificar" id="modificar" type="button" name="" value="Modificar"></a> 
          </td>
        </tr>
      </tbody>
...
<script>menu();
/*var url='../../CONTROLLERS/listar/personas-contagiadas.php';
listar(url);*/
