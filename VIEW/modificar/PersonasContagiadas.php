...
<tr>
          <td><?php echo $data['descentro'] ?></td>

          <td><input type="number" class="input val" name="personasC[]" id="recuperados" value="<?php echo $data["contagiados"] ?>" placeholder="Intruduzca un valor numérico"></td>
 ...
 ?>
        ...
        <tr>
          <td colspan="2"><input class=" btn btn-success btn-enviar" type="submit" id="btn-enviar" name="modificar" value="Enviar"></input></td>
        </tr>
      </table>
 <!--  <select name="">
...
<script>
  ...
  menu();
BtnEnviar_Modificar()
enviar('../../CONTROLLERS/agregar/personas-contagiadas.php','../../VIEW/listar/personas-contagiadas.php')
