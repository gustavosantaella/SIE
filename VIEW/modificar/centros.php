...
include_once("../../CONTROLLERS/administrar/centros.php");
...
<body>
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container-fluid" >
      ...
      <form id="formulario" method="post" action="../../CONTROLLERS/administrar/centros.php" name="formulario">
       <table border="1">
        <tr>
          <td>Centro</td><td><input type="text" class="input val" name="descentro" id="recuperados" value="<?php echo $datos['descentro'] ?>" placeholder="País"></td>
        </tr>
      ...
      <tr>
   <input hidden="" name="codcentro" value="<?php echo $datos['codcentro']?>" placeholder="">
...
BtnEnviar_Modificar()
enviar("../../CONTROLLERS/administrar/centros.php",'../administrar/centros.php')
