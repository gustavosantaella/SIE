...
$fecha=$p['fecha'];
              ...
              <tr class="borderTable">
               <th align="center" class="borderTable"> <?php echo $p['despai'] ?><input type="hidden" name="ids[]" value="<?php echo $p['id'] ?>" placeholder=""><input type="hidden" required=""name="codpais[]" value="<?php echo $p['codpai'] ?>" placeholder=""></th>
               <!--  <td><input type="number" class="val input"required="" name="recuperados[]" value="" placeholder="campo numérico"></td> -->
               <td class="borderTable"><input type="number" style="width: 100%;" class="val input"required="" name="contagiados[]" value="<?php echo $p['contagiados'] ?>" placeholder="campo numérico"></td>
               <td class="borderTable"><input type="number" style="width: 100%;" class="val input"required="" name="fallecidos[]" value="<?php echo $p['fallecidos'] ?>" placeholder="campo numérico"></td>
      ...
      <tbody>
        ...
        <?php while ($p = $pais[1]->fetch()) {
          ...
          <tr class="borderTable">
           ...
           <!--  <td><input type="number" class="val input"required="" name="recuperados[]" value="" placeholder="campo numérico"></td> -->
           <td class="borderTable"><input type="number" style="width: 100%;" class="val input"required="" name="contagiados[]" value="<?php echo $p['contagiados'] ?>" placeholder="campo numérico"></td>
           <td class="borderTable"><input type="number" style="width: 100%;" class="val input"required="" name="fallecidos[]" value="<?php echo $p['fallecidos'] ?>" placeholder="campo numérico">
           </td>
           <!-- <td><input type="number"class="val input" required="" name="fallecidos[]" value="" placeholder="campo numérico"></td> -->
         </tr>
         <?php 
...
<table>
  <tr>
   <tr class="borderTable">
    <td colspan="4" class='move-fecha'><input class="fecha borderTable" style="width: 100%;" required="" name="fecha" type="text" id="fecha" placeholder="dd/mm/yyyy" value="<?php echo $fecha ?>"></input></td>
  </tr>
  <tr>
...
BtnEnviar_Modificar()
enviar('../../CONTROLLERS/agregar/cuadro.php','../../view/listar/cuadro.php')
</script>
