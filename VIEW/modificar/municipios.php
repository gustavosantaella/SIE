...
include_once("../../CONTROLLERS/administrar/municipios.php");
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container-fluid" >
      ...
      <form id="formulario" method="post" action="../../CONTROLLERS/administrar/estados.php" name="formulario">
       <table border="1">
        <tr>
          <td>Municipio</td><td><input type="text" class="input val" name="municipio" id="recuperados" value="<?php echo $mun['desmun'] ?>" placeholder="País"></td>
        </tr>
...
BtnEnviar_Modificar()
enviar("../../CONTROLLERS/administrar/municipios.php",'../administrar/municipios.php')
