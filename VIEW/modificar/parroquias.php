...
include_once("../../CONTROLLERS/administrar/parroquias.php");
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container-fluid" >
      ...
      <form id="formulario" method="post" action="../../CONTROLLERS/administrar/estados.php" name="formulario">
       <table border="1">
        <tr>
          <td>Parroquia</td><td><input type="text" class="input val" name="parroquia" id="recuperados" value="<?php echo $par['despar'] ?>" placeholder="País"></td>
        </tr>
...
BtnEnviar_Modificar()
enviar("../../CONTROLLERS/administrar/parroquias.php",'../administrar/parroquias.php')
