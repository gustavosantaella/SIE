...
<div id="page-content-wrapper">
  ...
  <div class="container-fluid" >
    ...
    <form id="formulario" method="post" action="../../CONTROLLERS/modificar/modificarRelacion.php" name="formulario">
     <table border="1">
...
while($d = $data->fetch()): $fecha = $d['fecha'];?>
 ...
 <tr>
   ...
   <td><input  class="input val" type="number" name="recu[]" value="<?php echo $d['recuperados'] ?>" placeholder="Valor numérico"></td>
   <td><input  class="input val" type="number" name="conta[]" value="<?php echo $d['contagiados'] ?>" placeholder="Valor numérico"></td>
...
BtnEnviar_Modificar();
enviar('../../CONTROLLERS/agregar/relaciones.php','../../VIEW/listar/relaciones.php')
</script>
